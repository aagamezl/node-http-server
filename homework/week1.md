Using the code that we developed in yesterday's session and that is in the repository https://github.com/aagazl/node-http-server, we must perform the following tasks:
